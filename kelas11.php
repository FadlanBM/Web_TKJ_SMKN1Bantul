    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="" href="index.html">Home</a></li>
          <li class="dropdown"><a class="" href="#"><span>Profil</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
          ...
          <li class="dropdown"><a class="active" href="#"><span>Data TKJ</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                    <li class="dropdown"><a class="active" class="active" href="#"><span>Data Siswa</span> <i class="bi bi-chevron-right"></i></a>
                      <ul>
                        <li><a href="kelas10.php">Kelas 10</a></li>
                        <li><a class="active" href="kelas11.php">Kelas 11</a></li>
