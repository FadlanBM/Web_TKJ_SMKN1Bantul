...
<head>
  ...
  <!-- Favicons -->
  <link href="	https://www.smkn1bantul.sch.id/media_library/images/7963fd134a319515ae2933b360d167b0.png" rel="icon">
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      <a class="navbar-brand" href="index.html">
        <img src="assets/img/Logo-removebg-preview.png" alt="" width="65" height="65" class="d-inline-block align-text-top">
        TKJ smk n1 bantul
      </a>
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="" href="index.html">Home</a></li>
          <li class="dropdown"><a class="active" href="#"><span>Profil</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
          ...
          <li class="dropdown"><a href="#"><span>Data TKJ</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                    <li class="dropdown"><a href="#"><span>Data Siswa</span> <i class="bi bi-chevron-right"></i></a>
                      <ul>
                        <li><a href="Datasiswa/kelas10.php">Kelas 10</a></li>
                        <li><a href="Datasiswa/kelas11.php">Kelas 11</a></li>
                        <li><a href="Datasiswa/kelas12.php">Kelas 12</a></li>
                      </ul>
                    </li>
